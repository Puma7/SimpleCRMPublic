...
Den Workflow-Editor sehen Agent und Viewer schreibgeschützt: Neu, Speichern, Löschen, Import, Vorlagen, Anordnen, Aktiv-Schalter, Zeitplan, „Jetzt ausführen“, Inbound-Backfill und das Laden oder Speichern von Versionen sind gesperrt. Liste, Graph, Lauf-Historie, Versionsliste, Export und der Dry-Run bleiben offen. Im Tab „Automatisierung“ sind die Workflow-Optionen für sie nur lesbar.
