...
export const RLS_POLICY_COVERAGE_TABLES: readonly RlsPolicyCoverageTable[] = [
  ...
  rlsPolicyTable('mail_acl_bindings'),
  rlsPolicyTable('mail_acl_binding_permissions', [
    'mail_acl_bindings',
    'binding.id',
    'mail_acl_binding_permissions.binding_id',
    'app.can_access_workspace',
    'binding.workspace_id',
  ]),
  rlsPolicyTable('mail_acl_binding_constraints', [
    'mail_acl_bindings',
    // Constraints inherit workspace isolation via binding FK + explicit workspace_id policy.
    'app.can_access_workspace',
    'workspace_id',
  ]),
