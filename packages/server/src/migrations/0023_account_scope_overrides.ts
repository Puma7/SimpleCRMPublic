...
END $$;`,
    ...
    'ALTER TABLE email_canned_responses ADD COLUMN IF NOT EXISTS account_source_sqlite_id bigint;',
    ...
    'ALTER TABLE email_ai_prompts ADD COLUMN IF NOT EXISTS account_source_sqlite_id bigint;',
    ...
    'ALTER TABLE workflow_knowledge_bases ADD COLUMN IF NOT EXISTS account_source_sqlite_id bigint;',
    ...
    'ALTER TABLE email_workflows ADD COLUMN IF NOT EXISTS account_source_sqlite_id bigint;',
  ...
  downSql: [
    ...
    'ALTER TABLE email_workflows DROP COLUMN IF EXISTS override_key;',
    'ALTER TABLE email_workflows DROP COLUMN IF EXISTS account_id;',
    'ALTER TABLE workflow_knowledge_bases DROP COLUMN IF EXISTS override_key;',
    'ALTER TABLE workflow_knowledge_bases DROP COLUMN IF EXISTS account_id;',
    'ALTER TABLE email_ai_prompts DROP COLUMN IF EXISTS override_key;',
    'ALTER TABLE email_ai_prompts DROP COLUMN IF EXISTS account_id;',
    'ALTER TABLE email_canned_responses DROP COLUMN IF EXISTS override_key;',
    'ALTER TABLE email_canned_responses DROP COLUMN IF EXISTS account_id;',
    'ALTER TABLE email_thread_aliases DROP COLUMN IF EXISTS account_id;',
    'ALTER TABLE email_thread_aliases DROP COLUMN IF EXISTS account_source_sqlite_id;',
    'ALTER TABLE email_threads DROP COLUMN IF EXISTS account_id;',
    'ALTER TABLE email_threads DROP COLUMN IF EXISTS account_source_sqlite_id;',
  ],
};
