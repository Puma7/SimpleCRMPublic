...
export function applyEmailIpcSchemas(map: Map<InvokeChannel, SchemaEntry>): void {
  ...
  const emailEvidenceSummarySchema = z.object({
    ...
    mdnDisplayedCount: z.number().int().nonnegative(),
    pixelFetchCount: z.number().int().nonnegative(),
    automatedPixelFetchCount: z.number().int().nonnegative(),
    unknownPixelFetchCount: z.number().int().nonnegative(),
    probableHumanPixelFetchCount: z.number().int().nonnegative(),
    probableHumanOpenSessionCount: z.number().int().nonnegative(),
    automatedLinkFetchCount: z.number().int().nonnegative(),
    unknownLinkFetchCount: z.number().int().nonnegative(),
    probableHumanLinkFetchCount: z.number().int().nonnegative(),
    firstPixelFetchedAt: z.string().nullable(),
    lastPixelFetchedAt: z.string().nullable(),
    firstProbableHumanOpenAt: z.string().nullable(),
    lastProbableHumanOpenAt: z.string().nullable(),
    openCount: z.number().int().nonnegative(),
    clickCount: z.number().int().nonnegative(),
    automatedOpenCount: z.number().int().nonnegative(),
    probableOpenCount: z.number().int().nonnegative(),
    automatedClickCount: z.number().int().nonnegative(),
    probableClickCount: z.number().int().nonnegative(),
