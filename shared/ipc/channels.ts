...
const EmailChannels = literal({
  ...
  ListMessageIdsByView: 'email:list-message-ids-by-view',
  ...
  BulkSetMessageSpamStatus: 'email:bulk-set-message-spam-status',
  BulkSetMessageDone: 'email:bulk-set-message-done',
  BulkDeleteComposeDrafts: 'email:bulk-delete-compose-drafts',
  ...
  PreviewRestoreLocalMailBackup: 'email:preview-restore-local-mail-backup',
  RestoreLocalMailBackup: 'email:restore-local-mail-backup',
  ...
  GetEmailTrackingSettings: 'email:get-tracking-settings',
  ...
  ListSmtpRelays: 'email:list-smtp-relays',
  CreateSmtpRelay: 'email:create-smtp-relay',
  UpdateSmtpRelay: 'email:update-smtp-relay',
  DeleteSmtpRelay: 'email:delete-smtp-relay',
  AddSmtpRelayAccount: 'email:add-smtp-relay-account',
  RemoveSmtpRelayAccount: 'email:remove-smtp-relay-account',
  CreateSmtpRelayCredential: 'email:create-smtp-relay-credential',
  RevokeSmtpRelayCredential: 'email:revoke-smtp-relay-credential',
  ListSmtpRelaySubmissions: 'email:list-smtp-relay-submissions',
  ...
  SetMessageSpamStatus: 'email:set-message-spam-status',
  ListSpamListEntries: 'email:list-spam-list-entries',
  ...
  ListWorkflowDelayedJobs: 'workflow:list-delayed-jobs',
  ...
  // TA-P5 Learnings: Verwaltung Owner/Admin (Server workflows.manage), Notiz für alle mit Lesezugriff.
  GetLearningsOverview: 'workflow:learnings-overview',
  SaveLearningsSettings: 'workflow:learnings-save-settings',
  ListLearningCandidates: 'workflow:learnings-list-candidates',
  DeleteLearningCandidate: 'workflow:learnings-delete-candidate',
  RunLearningsDigest: 'workflow:learnings-run-digest',
  ListLearningDigests: 'workflow:learnings-list-digests',
  GetLearningDigest: 'workflow:learnings-get-digest',
  AcceptLearningDigest: 'workflow:learnings-accept-digest',
  RejectLearningDigest: 'workflow:learnings-reject-digest',
  AddLearningNote: 'email:add-learning-note',
