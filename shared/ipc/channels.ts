...
const EmailChannels = literal({
  ...
  RetryScheduledSendDraft: 'email:retry-scheduled-send-draft',
  GetComposeDraftRecoveryState: 'email:get-compose-draft-recovery-state',
  ...
  GetMessageSecurity: 'email:get-message-security',
  ...
  SaveKnowledgeBaseDocument: 'workflow:save-knowledge-base-document',
  ExportKnowledgeBaseDocument: 'workflow:export-knowledge-base-document',
